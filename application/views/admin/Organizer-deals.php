                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row heading-bg">
                                    <div class="col-lg-12 col-md-4 col-sm-4 col-xs-12">
                                        <h5 class="txt-dark">Organizer Deals <span class="pull-right">25</span></h5>
                                    </div>
                                </div>
                                <!-- Row -->
                                <div class="row">
                                                    ...
                                                    <div class="social-info">    
                                                        <div class="row">
                                                            <div class="col-xs-6 text-center">
                                                                ...
                                                                <span class="counts-text block">No of Deals</span>
                                                            </div>
                                    ...
                                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                        <div class="panel panel-default card-view panel-refresh">
                                            ...
                                            <div class="panel-heading">
                                                <div class="pull-left">
                                                    <h6 class="panel-title txt-dark">Organizer Deasls List</h6>
                                                </div>
                                                            ...
                                                            <table class="table table-hover mb-0">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td><span class="txt-dark ">Lorem ipsum </span></td>
                                                                        <td><span class="txt-success weight-600">AED 75.00 </span> &nbsp; <span class="txt-grey"><del>AED 75.00</del></span> </td>
                                                                        <td>30%</td>
                                                                        <td><span class="block txt-dark weight-500 font-12 pt-5 mb-10"><i class="fa fa-square txt-warning font-16 mr-10 mb-10"></i>  999   </span></td>
                                                                        <td>MON - FRI</td>
                                                                        <td>
                                                                            <button class="btn btn-defolt btn-rounded btn-xs uppercase-font pull-right">Explore</button>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><span class="txt-dark ">Lorem ipsum </span></td>
                                                                        ...
                                                                        <td>MON - FRI</td>
                                                                        <td>
                                                                            <button class="btn btn-primary btn-rounded btn-xs uppercase-font pull-right desiable">Active</button>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
