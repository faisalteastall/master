                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="panel panel-default card-view panel-refresh">
                                            ...
                                            <div class="panel-heading">
                                                <div class="pull-left">
                                                    <h6 class="panel-title txt-dark">Purchasers list</h6>
                                                </div>
                                            ...
                                            <div class="panel-wrapper collapse in">
                                                ...
                                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6">
                                                        <div class="profile-box card-view">
                                                            <div class="profile-cover-pic" style="background:url(img/pr.jpg);">
                                                                <div class="profile-image-overlay"></div>
                                                            </div>
                                                            <div class="profile-info text-center">
                                                                <div class="profile-img-wrap">
                                                                    <img class="inline-block mb-10" src="img/avatar.jpg" alt="user"/>
                                                                </div>	
                                                                <h5 class="block mt-10 mb-5 weight-500 capitalize-font txt-success">Name</h5>                                                               
                                                                <h6 class="block capitalize-font">
                                                                    <i class="fa fa-phone font-14"></i> &nbsp;  <span class="font-13">9700025000 </span>
                                                                </h6>
                                                            </div>	
                                                            <div class="social-info">
                                                            <div class="product-detail-wrap">
                                                                <div class=" mb-10"> <span class="txt-success weight-600">Deals name </span> &nbsp; <span class="txt-grey"><del>name</del></span></div>
                                                                <span class="block txt-dark weight-500 font-12 pt-5 mb-10"><i class="fa fa-square txt-warning font-16 mr-10 mb-10"></i> Get 25 points  </span>
                                                                <span class="block txt-grey weight-500 font-12 pt-5 uppercase-font pull-left">
                                                                    Date & Time <span class="text-primary">24-sep. MON - 21:20 AM</span>
                                                                </span>                                                                   
                                                            </div> 
                                                                <div class="row">
                                                                                                                                
                                                                    <div class="clearfix"></div>
                                                                    <!-- <button class="btn btn-primary btn-block  btn-anim mt-30" data-toggle="modal" data-target="#myModal"><i class="fa fa-eye"></i><span class="btn-text">View Details</span></button> -->
                                                                </div>       
                                                            </div>
                                                        </div>                                                          
                                                    </div>	
