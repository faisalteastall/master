                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row heading-bg">
                                    <div class="col-lg-12 col-md-4 col-sm-4 col-xs-12">
                                        <h5 class="txt-dark">Organizer Location <span class="pull-right">25</span></h5>
                                    </div>
                                </div>
                                <!-- Row -->
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                        <div class="panel panel-default card-view panel-refresh">
                                            ...
                                            <div class="panel-heading">
                                                <div class="pull-left">
                                                    <h6 class="panel-title txt-dark">Organizer Location List</h6>
                                                </div>
                                                            ...
                                                            <table class="table table-hover mb-0">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td><span class="txt-dark"><a class="btn btn-default btn-outline fancy-button btn-0 mt-0" href="location-visitor.php">25</a> </span></td>
                                                                        ...
                                                                        <td><span class="txt-dark"><a class="btn btn-default btn-outline fancy-button btn-0 mt-0" href="location-photos.php">2</a> </span></td>
                                                                        <td>
